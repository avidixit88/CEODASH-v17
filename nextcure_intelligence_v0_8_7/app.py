...
from ui.layout import render_hero, render_insights, render_kpi_cards, render_watch_items, render_dashboard_nav
...
if st.session_state.analysis_started and st.session_state.results is not None:
    ...
    st.markdown(
        ...
        <div class="card">
            ...
            <div class="muted">
                Iteration 8.7 combines the premium START workflow with real market data, explicit 30D / 60D / Quarterly 90D return windows,
                peer-channel classification, catalyst meaning, capital-flow intelligence, market window scoring, scenario outlook, advanced technical positioning, catalyst timing comparison, and adaptive market-activation guidance that changes with the incoming data. The interaction remains one-button and backend-driven.
            </div>
        </div>
        """,
        unsafe_allow_html=True,
